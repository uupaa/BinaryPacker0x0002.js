...
BinaryPacker0x0002["getBytes"] = BinaryPacker0x0002_getBytes; // BinaryPacker0x0002.getBytes(source:Any):Integer

// --- implements ------------------------------------------
function BinaryPacker0x0002_getBytes(source) { // @arg Object - { x, y, w, h, delay, blend, dispose, pixels }
                                               // @ret Integer
// header
//  | bytes | keyword    | value                               |
//  |-------|------------|-------------------------------------|
...
//}@dev
    ...
    var bodyLength = 14 + source["pixels"].length;
    var result = new Uint8Array(BinaryPacker0x0002_getBytes(source));
    var x = source["x"];
    var y = source["y"];
    var w = source["w"];
    var h = source["h"];
